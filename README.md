### Articles and docs that helped in various situations:

- [node docs](https://nodejs.org/en)
- [express docs](https://expressjs.com/)
- [mongoose docs](https://mongoosejs.com/docs/index.html)
- [setting up typescript with node](https://www.digitalocean.com/community/tutorials/setting-up-a-node-project-with-typescript)
- [setting up typescript with node - alternative source](https://medium.com/@induwara99/a-step-by-step-guide-to-setting-up-a-node-js-project-with-typescript-6df4481cb335)
